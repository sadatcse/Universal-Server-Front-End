...
const DataImportPage = () => {
    ...
    const handleImport = () => {
        ...
        console.log(`Importing data from ${fileType} file.`);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-10 flex justify-center">
                    <div className="flex flex-col items-center space-y-4">
                        <label htmlFor="file-upload" className="cursor-pointer bg-white rounded-lg p-4 border border-gray-300 shadow-md hover:border-blue-500 hover:bg-blue-50 transition duration-300 ease-in-out">
                            {selectedFile ? (
