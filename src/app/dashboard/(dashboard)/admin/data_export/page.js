...
const DataExportPage = () => {
    ...
    const handleExport = (format, startDate, endDate) => {
        ...
        console.log(`Exporting data in ${format} format for date range: ${startDate} - ${endDate}`);
        toast.success(`Exported data successfully in ${format} format for date range: ${startDate} - ${endDate}`);
    };
