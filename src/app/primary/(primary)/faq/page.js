...
<div className="flex flex-wrap items-center justify-center bg-slate-50 border-double rounded">
 ...
 <div className="w-full lg:w-1/2 p-4">
   <img
     ...
     src="https://i.ibb.co/fH9dZ10/faq.png"
     alt="Faq Image"
   />
 </div>
 ...
 <div className="w-full lg:w-1/2 p-4">
   <div className="max-w-md mx-auto">
     {faqData.map((faqItem, index) => (
        <div tabIndex={index} className="collapse collapse-plus border border-base-300 bg-base-200 mb-4">
        <div className="collapse-title text-xl font-medium">
        {faqItem.question}
        </div>
        <div className="collapse-content"> 
          <p>tabIndex={index} {faqItem.answer}</p>
        </div>
      </div>
