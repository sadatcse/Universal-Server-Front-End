        ...
        <section className=" relative z-[1] dark:bg-transparent bg-amber-200" id="faqHero">
            ...
            <div className="container grid grid-cols-1 md:grid-cols-2 p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between gap-4 gap-x-10">
                {faqData.map((faqItem, index) => (
                    <a href={`#ans${index === 0 ? "" : index }`} key={index} className="collapse collapse-plus bg-white hover:bg-neutral-800 hover:text-white scale-100 hover:scale-105 transition-all duration-700 text-neutral-800">
