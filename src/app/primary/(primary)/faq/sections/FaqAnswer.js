  ...
  return (
    <section className=" relative z-[1] bg-blue-300 dark:bg-transparent pt-16" id="ans">
            ...
            {faqData.map((faqItem, index) => (
                    <section id={`ans${faqItem.id}`} key={index} className="flex flex-col group items-start text-left p-12 border shadow-lg rounded-md bg-white hover:bg-amber-200 hover:shadow-2xl hover:scale-105 transition-all duration-300 sm:pr-44 relative text-neutral-800 max-w-[900px] mx-auto">
                    ...
                    <a href="#faqHero" className="w-10 sm:w-16 h-12 sm:h-24 sm:-translate-y-1/2 absolute top-6 sm:top-1/2 rounded-lg right-10 text-white bg-neutral-800 flex justify-center items-center text-5xl"><LiaLongArrowAltUpSolid /></a>
                </section>
