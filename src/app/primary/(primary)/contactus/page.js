...
const ContactUS = () => {
    return (
        <section className="hero container mx-auto my-16 relative overflow-hidden px-0 lg:px-24">
                <div className="p-8 flex-shrink-0 w-full  bg-[#E9F1FA] rounded-lg relative overflow-hidden text-neutral-800 z-[1]">
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="form-control mt-6">
                            <button className="border border-transparent btn rounded-md bg-[#00ABE4] text-white shadow font-semibold  hover:bg-white hover:border-[#00abe4]  hover:text-[#00ABE4] transition duration-500 ease-in-out">Send</button>
                        </div>
                    </form>
                </div>
        </section>
