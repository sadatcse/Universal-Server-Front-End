...
function Footer() {
  return (
    <footer className="p-6 pt-28 dark:bg-neutral-800 dark:border-t dark:text-gray-100  text-white bg-neutral-900">
      <div className="w-[80%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <p>
              Our goal is to simplify the process of survey creation,
              distribution, and analysis, making feedback collection effortless
              for individuals.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <LuMail className="text-2xl" />{" "}
            <p>Official : universalsurvey@support.com</p>
          </div>
          <div className="flex items-center gap-3">
            <IoCallOutline className="text-2xl" />{" "}
            <p>Helpline : 01313524255 , 01968547543</p>
          </div>
        </div>
          ...
          <div className="mt-10">
            <div className="flex items-center rounded max-w-min bg-white">
              <input
                ...
                className="rounded rounded-r-none outline-none  text-gray-500 py-1 pl-3 text-sm"
              ></input>
              <button className="p-2 rounded font-bold text-lg border dark:bg-neutral-800 bg-[#00ABE4] rounded-l-none right-28">
                <RiMailSendFill />
              </button>
            </div>
          </div>
      ...
      <div className="w-[80%] mx-auto my-4 flex justify-between flex-wrap">
        ...
        <div className="text-gray-300 items-center flex gap-2">
          <div className="flex items-center gap-1">
            <Link href="/primary/privacy">
              <p>Privacy Policy</p>
            </Link>
          </div>
          <div className="flex items-center gap-1">
            <Link href="/primary/presskit">
              <p>Press Kit</p>
            </Link>
          </div>
        </div>
