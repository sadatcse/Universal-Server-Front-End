    ...
    <header className="flex flex-wrap lg:justify-start lg:flex-nowrap items-center z-50 w-full top-0 left-0 text-sm bg-transparent transition-all duration-500 relative" id="header" >
      <div className="navbar">
        <div className="navbar-start">
          ...
          <Link href="/" className="btn btn-ghost text-xl hover:bg-transparent"><Image className="w-16 mix-blend-multiply" width={400} height={400} src={logo} alt="logo" /> <span className="font-exo  hidden sm:block dark:text-white" id="logo_name">Universal Survey</span></Link>
        </div>
