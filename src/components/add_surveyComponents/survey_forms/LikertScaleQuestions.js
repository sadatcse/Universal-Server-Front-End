...
function LikertScaleQuestions({setShowSurveyForm, setSurveyQuestions, setOpenAddQuestionModal}) {
  ...
  return (
    <div class="p-4 py-8 relative">
        <div class="heading text-center font-bold text-4xl m-5 text-gray-800 bg-white ">Likert Scale Questions form</div>
