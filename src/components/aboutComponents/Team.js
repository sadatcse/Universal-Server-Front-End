...
const Team = () => {
    ...
    return (
        ...
        <h1 className='text-4xl font-bold py-4 col-span-full dark:text-white'>Meet the team</h1>
            <div className="col-span-full md:col-span-4">
            
                <div className="w-full text-lg relative z-[1] group overflow-hidden p-8 hidden md:block text-neutral-800">
                ...
                <div className="w-full p-4 grid grid-cols-1 sm:grid-cols-2 justify-center lg:grid-cols-4 md:max-h-[400px] md:overflow-auto gap-6 bg-amber-100">
