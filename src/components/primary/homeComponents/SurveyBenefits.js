    ...
    return (
        <section className="m-4 md:m-8 text-neutral">
            ...
            <div className="container mx-auto grid justify-center gap-12 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div key={ind} className="flex flex-col group items-start text-left p-12 border shadow-lg rounded-md hover:bg-blue-200 hover:shadow-2xl hover:scale-110 transition-all duration-300 dark:text-white dark:hover:text-neutral">
