        ...
        <div className="w-full h-full absolute top-0 left-0 z-[-1] dark:hidden" style={{backgroundImage: `url("/home-banner.jpg")`, backgroundSize: "cover", backgroundPosition: "center"}}></div>
            <div className="relative container mx-auto">
                ...
                <div className="flex flex-col-reverse md:flex-row justify-center md:justify-start items-center gap-10 h-full overflow-hidden">
                    ...
                    <div className="p-12 mx-4 md:mx-0 w-full md:w-1/2 rounded-xl shadow-3xl sm:flex justify-center items-center bg-amber-100 relative dark:bg-blue-200 hidden shadow-2xl ">
