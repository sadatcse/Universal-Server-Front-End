    ...
    <div class="p-4 relative">
        ...
        <form class="editor mx-auto w-full flex flex-col text-gray-800  rounded-md shadow-xl p-4  max-w-2xl bg-stone-200" onSubmit={onSubmit}>
          ...
          <div className="flex w-full justify-stretch rounded-lg overflow-hidden gap-3">
            ...
            <from className="space-y-4 border-2 rounded-lg p-3 border-neutral md:w-1/2 w-full" >
            <label htmlFor="title" className="font-bold text-2xl">Add Option</label>
            <input class="title border border-gray-300 p-2 mb-4 outline-none rounded" spellcheck="false" id="title" placeholder="Add Option" type="text" required ref={optionInput} onKeyUp={onEnter} />
