...
function LongTextQuestion({setShowSurveyForm, setSurveyQuestions, setOpenAddQuestionModal, currentQuestion, setCurrentQuestion}) {
  const [questionInput, setQuestionInput] = useState( currentQuestion.question || "");
    const onSubmit = (e)=> {
      ...
      useEffect(()=> {
        ...
        const newObject = {questionType: "long_text" , question: questionInput, answer: ""}
