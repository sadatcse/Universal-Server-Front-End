...
export default function DemoModal({ currentQuestion, setCurrentQuestion, surveyQuestions, setSurveyQuestions, setOpenDemoModal }) {
  return (
    <div className="fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black bg-opacity-50 py-10">
            <div className={`max-h-full w-full max-w-[800px] overflow-y-auto sm:rounded-2xl bg-white pt-12 p-8 transition-all duration-500 relative`} >
               ...
               <DemoSurveyQuestionModal currentQuestion={currentQuestion} setCurrentQuestion={setCurrentQuestion} surveyQuestions={surveyQuestions} setSurveyQuestions={setSurveyQuestions} />
